% function [paths,svv,arrayEffect,Npathtgt,Nraintgt] = helperRainPaths(tgt_pos_rel,tgt_rng_rel,tgt_ang_rel,tgt_vel_rel,lambda,rcsgain,...
%     rcsrate_rain_pow,fc,tgt_rng_max,R_max_rain,rainrate,rain_az,r_res,txArray,rxArray)
function [paths,Npathtgt,Nraintgt] = helperRainPaths(tgt_pos_rel,tgt_rng_rel,tgt_ang_rel,tgt_vel_rel,lambda,rcsgain,...
    rcsrate_rain_pow,fc,tgt_rng_max,R_max_rain,rainrate,rain_az,r_res)
